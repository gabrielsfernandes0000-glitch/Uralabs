      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          <Reveal width="100%">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-white mb-3">Espia antes de entrar</h2>
            <p className="text-[14px] text-white/55 max-w-xl mx-auto">
              {data.fallback
                ? "Snapshot do Discord indisponível agora. Entra direto lá pra ver o que rola ao vivo."
                : `Isso é o que rola lá dentro — todos os dias. ${data.memberCount.toLocaleString("pt-BR")} traders compartilhando resultados, tirando dúvidas e evoluindo juntos. Entrada gratuita.`}
            </p>
            {!data.fallback && data.snapshotAt && (
              <p className="text-[10px] text-white/30 mt-3">
                Snapshot atualizado a cada 5 min · dados reais da guild
              </p>
            )}
          </Reveal>
        </div>
        ...
        <Reveal delay={0.2} width="100%">
          <div className="relative">
            {/* Discord mockup */}
            <div className="relative bg-[#313338] rounded-md border border-white/[0.08] overflow-hidden flex h-[520px]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
              <a
                ...
                onClick={() => trackEvent("click_discord_free", { location: "discord_widget" })}
                className="inline-flex items-center gap-2.5 px-6 h-11 bg-[#5865F2] hover:bg-[#4752C4] text-white text-[13px] font-semibold rounded-md transition-colors"
              >
