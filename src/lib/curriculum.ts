...
export const CURRICULUM: ModuleData[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        hasPdf: true,
        quiz: [
          { question: "Sua conta tem $25.000. Você encontrou um setup A+ com entry, SL e TP definidos. O SL dá um risco de $400. Deve entrar nesse trade?", options: ["Sim, setup A+ vale o risco", "Não — $400 é 1.6% da conta, acima do limite de 1% ($250)", "Sim, se estiver confiante", "Depende do horário"], correct: 1, explanation: "1% de $25.000 = $250. Um trade com risco de $400 = 1.6%, acima do limite. A solução: reduzir o lote até o risco caber em $250, ou não entrar. Setup bom com risco errado continua sendo um trade ruim. Gerenciamento > estratégia." },
